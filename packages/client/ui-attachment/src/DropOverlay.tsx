...
const UploadIllustration = () => (
  <svg width="115" height="84" viewBox="0 0 115 84" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#dshDropOverlayClip)">
      <rect y="17.0742" width="44.1832" height="43.6431" rx="12" transform="rotate(-22.7338 0 17.0742)" fill="var(--dsw-specific-drop-overlay-back-card, #9CE5ED)" />
      <rect x="73.4043" y="8.54297" width="43.7267" height="50.5284" rx="8" transform="rotate(17.403 73.4043 8.54297)" fill="var(--dsw-specific-drop-overlay-side-card, #679EFE)" />
      <path d="M30.4917 28.1369L40.8865 33.4564L37.2232 34.9524L29.5302 31.0159L26.7919 39.2122L23.1285 40.7082L26.8287 29.6338L16.8967 24.5516L20.5601 23.0556L27.7902 26.7549L30.3639 19.052L34.0273 17.556L30.4917 28.1369Z" fill="var(--dsw-specific-drop-overlay-back-card-foreground, white)" />
      <path d="M77.5088 26.3047L101.057 33.7966" stroke="var(--dsw-specific-drop-overlay-side-card-foreground, white)" strokeWidth="3" />
      <path d="M72.2646 42.7871L86.3938 47.2823" stroke="var(--dsw-specific-drop-overlay-side-card-foreground, white)" strokeWidth="3" />
      <path d="M74.8867 34.5469L98.4353 42.0388" stroke="var(--dsw-specific-drop-overlay-side-card-foreground, white)" strokeWidth="3" />
      <rect x="31.583" y="38.6641" width="44.9157" height="44.3666" rx="12" transform="rotate(-0.134233 31.583 38.6641)" fill="var(--dsw-specific-drop-overlay-front-card, #3964FE)" />
      <path d="M38.9521 73.0337C39.6129 71.7086 41.7113 66.0937 43.5113 61.1663C44.1607 59.3885 46.7484 59.3923 47.4591 61.1465C48.9728 64.8828 50.7969 68.6922 51.9988 69.1925C54.2946 70.1482 57.9854 59.3573 68.0064 70.1801" stroke="var(--dsw-specific-drop-overlay-front-card-foreground, white)" strokeWidth="3" />
      <circle cx="60.6157" cy="52.247" r="4.38794" transform="rotate(22.5996 60.6157 52.247)" fill="var(--dsw-specific-drop-overlay-front-card-foreground, white)" />
    </g>
    <defs>
