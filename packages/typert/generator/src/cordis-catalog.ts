...
function renderRuntimeApi(
  ...
  const lines: string[] = [
    '/**',
    ' * Generated by scripts/gen-cordis-inspect-catalog.ts; do not edit by hand.',
    ' * Run `pnpm run gen-cordis-inspect-catalog` to regenerate and',
    ' * `pnpm run verify-cordis-inspect-catalog` to verify freshness.',
    ' *',
    ...
    ' * harness events (mode + structured listener contracts), and the inherited',
    ' * `ctx` API. It is projected directly from source declarations.',
    ' *',
...
const BANNER = [
  '<!-- Generated by the Typert Cordis catalog renderer; do not edit by hand.',
  '     The calling repository owns regeneration and freshness checks. -->',
  '',
]

/** The shared GENERATED + freshness-gate + fence notice paragraph. */
const GATE_NOTICE = 'This file is generated from source by the Typert Cordis catalog renderer; do not edit it by hand. The calling repository owns regeneration and freshness checks. Signature blocks use a `ts cordis-catalog` fence and include the original source JSDoc immediately before each event or service method; type names in a signature link to the page that documents them.'
...
export function renderPageRegion(page: string, services: ServiceEntry[], events: EventEntry[], policy: CordisCatalogPolicy): string {
  const lines: string[] = [
    ...
    '## Cordis API',
    '',
    'Generated from source by the Typert Cordis catalog renderer; this section is byte-identical in both language sides of the page. The calling repository owns regeneration and freshness checks. Signature blocks use a `ts cordis-catalog` fence and keep the original source JSDoc.',
    '',
  ]
