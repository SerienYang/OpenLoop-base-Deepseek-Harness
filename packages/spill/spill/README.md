...
See the tool output spill Agent Note for the design rationale, including why creation belongs to the runtime spill seam rather than the model-facing `write` tool.
