/**
 * Package-owned invariant companion for `@openloop/bundle`.
 * @module @openloop/bundle/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@openloop/bundle'

/** Cordis companion plugin name. */
export const name = 'openloop-bundle-invariant'
