...
const TOKEN_ROLES = {
  ...
  '--dsw-alias-button-info-foreground': 'action.primary.foreground',
  '--dsw-alias-button-info-hover': 'action.primary.hover-background',
  '--dsw-alias-label-primary': 'text.primary',
  '--dsw-alias-label-primary-bluish': 'text.primary',
  ...
  '--dsw-specific-drop-overlay-back-card': 'state.selected.background',
  '--dsw-specific-drop-overlay-back-card-foreground': 'state.selected.foreground',
  '--dsw-specific-drop-overlay-front-card': 'action.primary.background',
  '--dsw-specific-drop-overlay-front-card-foreground': 'action.primary.foreground',
  '--dsw-specific-drop-overlay-side-card': 'background.inverse',
  '--dsw-specific-drop-overlay-side-card-foreground': 'text.inverse',
  '--dsw-specific-hero-glow': 'text.secondary',
